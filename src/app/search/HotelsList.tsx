...
import {SearchParams, Hotel, OfferEntity, Offer} from './types'
...
export function HotelCard({hotel, offerEntity, isComplete = false}: {hotel: Hotel, offerEntity: OfferEntity, isComplete?: boolean}) {
  return (
